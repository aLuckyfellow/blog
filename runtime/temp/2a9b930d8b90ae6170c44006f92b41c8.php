<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"/var/www/blog/public/../app/admin/view/article/recycle.tpl";i:1522591212;s:47:"/var/www/blog/public/../app/admin/view/base.tpl";i:1522660452;}*/ ?>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                <li><a href="<?php echo url('admin/article/delArc',['arc_id'=>$vo['arc_id']]); ?>">从回收站删除</a></li>
                                                <li class="divider"></li>
                                                <li><a href="<?php echo url('admin/article/outRecycle',['arc_id'=>$vo['arc_id']]); ?>">恢复到文章列表</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
