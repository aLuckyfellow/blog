<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"/var/www/blog/public/../app/admin/view/article/store.tpl";i:1523543613;s:47:"/var/www/blog/public/../app/admin/view/base.tpl";i:1523543526;}*/ ?>
...
<div class="container-fluid admin_menu">
 ...
 <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
            ...
            <form class="form-horizontal" id="form"  action="<?php echo url('admin/article/addArticle'); ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                   ...
                                   <label class="checkbox-inline">
                                        <input type="checkbox" name="tag_id[]" value="<?php echo $vo['tag_id']; ?>"> <?php echo $vo['tag_name']; ?>
                                    </label>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
