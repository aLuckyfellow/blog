<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"/var/www/blog/public/../app/admin/view/link/index.tpl";i:1522587829;s:47:"/var/www/blog/public/../app/admin/view/base.tpl";i:1522660452;}*/ ?>
...
<div class="container-fluid admin_menu">
 ...
 <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li><a href="<?php echo url('admin/link/store'); ?>">友链添加</a></li>
            </ul>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($linkList) || $linkList instanceof \think\Collection || $linkList instanceof \think\Paginator): if( count($linkList)==0 ) : echo "" ;else: foreach($linkList as $key=>$vo): ?>
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li><a href="<?php echo url('admin/link/store',['link_id'=>$vo['link_id']]); ?>">编辑</a></li>
                                            <li class="divider"></li>
                                            <li><a href="<?php echo url('admin/link/delLink',['link_id'=>$vo['link_id']]); ?>">删除</a></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
