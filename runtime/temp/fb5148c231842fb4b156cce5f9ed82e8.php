<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"/var/www/blog/public/../app/admin/view/entry/pass.tpl";i:1522658933;s:47:"/var/www/blog/public/../app/admin/view/base.tpl";i:1522644239;}*/ ?>
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <h4 style="display: inline;line-height: 50px;float: left;margin: 0px"><a href="index.html" style="color: white;margin-left: -14px">潇欢博客</a>
                </h4>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <a href="http://fontawesome.dashgame.com/" target="_blank"><i
                                    class="fa fa-w fa-hand-o-right"></i> 图标</a>
                        </li>
                        <li>
                            <a href="http://bbs.houdunwang.com" target="_blank"><i class="fa fa-w fa-forumbee"></i> 后盾网</a>
                        </li>
                    </ul>
                </div>
...
<div class="container-fluid admin_menu">
 ...
 <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
            ...
            <form onsubmit="return changePass()" class="form-horizontal" id="form" action="<?php echo url('admin/entry/pass'); ?>" method="post">
...
<div class="master-footer" style="margin-top: 150px">
    ...
    <a href=""></a>
    <br>
    Powered by wephp v2.0 Â© 2016-2022 www.baidu.com
</div>
</body>
</html>