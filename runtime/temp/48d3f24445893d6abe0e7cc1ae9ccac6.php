<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:58:"/var/www/blog/public/../app/admin/view/link/web_config.tpl";i:1522587829;s:47:"/var/www/blog/public/../app/admin/view/base.tpl";i:1522660452;}*/ ?>
...
<div class="container-fluid admin_menu">
 ...
 <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
            ...
            <form class="form-horizontal" id="form"  action="<?php echo url('admin/link/web_config'); ?>" method="post">
                <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="<?php echo $data['web_name']; ?>" name="web_name"  class="form-control" ">
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="" class="col-sm-2 control-label">邮箱</label>
                            <div class="col-sm-9">
                                <input type="text" value="<?php echo $data['web_melie']; ?>" name="web_melie"  class="form-control" >
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                           <label for="" class="col-sm-2 control-label">版权</label>
                            <div class="col-sm-9">
                                <input type="text" value="<?php echo $data['web_conypt']; ?>"  name="web_conypt"  class="form-control">
