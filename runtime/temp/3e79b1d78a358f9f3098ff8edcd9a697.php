<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"/var/www/blog/public/../app/admin/view/article/edit.tpl";i:1523543793;s:47:"/var/www/blog/public/../app/admin/view/base.tpl";i:1523543526;}*/ ?>
...
<div class="container-fluid admin_menu">
 ...
 <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="<?php echo url('admin/article/index'); ?>">文章列表</a></li>
                <li class="active"><a href="">文章编辑</a></li>
            </ul>
            <form class="form-horizontal" id="form"  action="<?php echo url('admin/article/edit'); ?>" method="post">
                <div class="panel panel-default">
                   ...
                   <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="<?php echo $data['arc_title']; ?>" name="arc_title"  class="form-control" placeholder="文章题目">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" value="<?php echo $data['arc_author']; ?>" name="arc_author"  class="form-control" placeholder="文章作者">
                            </div>
                        </div>
                                ...
                                <select class="js-example-basic-single form-control" name="cate_id" >
                                    <option value="0">顶级分类</option>
                                     ...
                                     <?php if(is_array($cateData) || $cateData instanceof \think\Collection || $cateData instanceof \think\Paginator): if( count($cateData)==0 ) : echo "" ;else: foreach($cateData as $key=>$vo): ?>
                                        <option <?php if($data['cate_id']==$vo['cate_id']): ?>selected<?php endif; ?> value="<?php echo $vo['cate_id']; ?>"><?php echo $vo['cate_name']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                   ...
                                   <label class="checkbox-inline">
                                        <input type="checkbox" <?php if(in_array($vo['tag_id'],$tag_ids)): ?>checked<?php endif; ?> name="tag_id[]" value="<?php echo $vo['tag_id']; ?>"><?php echo $vo['tag_name']; ?>
                                    </label>
                                   <?php endforeach; endif; else: echo "" ;endif; ?>
                        ...
                        <div class="form-group">
                           <label for="" class="col-sm-2 control-label">文章图片</label>
                            <div class="col-sm-9">
                                <input type="text" name="arc_img" value="<?php echo $data['arc_img']; ?>" class="form-control" placeholder="网络获取">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea type="text" name="arc_digest" value="" class="form-control" placeholder="文章摘要"><?php echo $data['arc_digest']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for=""  class="col-sm-2 control-label">文章内容</label>
                            <div class="col-sm-9">
  <textarea name="arc_content"><?php echo $data['arc_content']; ?></textarea>
