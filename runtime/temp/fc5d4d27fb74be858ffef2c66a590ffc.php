<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:59:"/var/www/blog/public/../app/admin/view/category/addtage.tpl";i:1522589838;s:47:"/var/www/blog/public/../app/admin/view/base.tpl";i:1522660452;}*/ ?>
...
<div class="container-fluid admin_menu">
 ...
 <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
                ...
                <li class="active">
                    <a href="<?php echo url('admin/category/addtage'); ?>">栏目添加</a>
                </li>

            </ol>
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="<?php echo url('admin/category/index'); ?>">栏目列表</a></li>
                <li class="active"><a href="<?php echo url('admin/category/addtage'); ?>">栏目添加</a></li>
            </ul>
            <form class="form-horizontal" id="form" action="<?php echo url('admin/category/addtage'); ?>" method="post">
