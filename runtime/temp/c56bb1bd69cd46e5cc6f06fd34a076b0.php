<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:56:"/var/www/blog/public/../app/index/view/content/index.tpl";i:1522587828;s:47:"/var/www/blog/public/../app/index/view/base.tpl";i:1522843531;}*/ ?>
...
<main class="col-md-8">
						<article>
							<div class="_head">
								...
								•发表时间：
								<!--pubdate表⽰示发布⽇日期-->
								<time pubdate="pubdate"><?php echo $arcData['sendtime']; ?></time>
							</div>
							<div class="_digest">
								<p>
							...
							<div class="_footer">
								...
								<?php if(is_array($arcData['tags']) || $arcData['tags'] instanceof \think\Collection || $arcData['tags'] instanceof \think\Paginator): if( count($arcData['tags'])==0 ) : echo "" ;else: foreach($arcData['tags'] as $key=>$vo): ?>
