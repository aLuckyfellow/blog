<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:53:"/var/www/blog/public/../app/admin/view/link/store.tpl";i:1522587829;s:47:"/var/www/blog/public/../app/admin/view/base.tpl";i:1522660452;}*/ ?>
...
<div class="container-fluid admin_menu">
 ...
 <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
                <li>
                    <a href="<?php echo url('admin/link/index'); ?>"><i class="fa fa-cogs"></i>
                               友链管理</a>
                </li>
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li><a href="<?php echo url('admin/link/index'); ?>">友链管理</a></li>
                <?php if(input('param.link_id')): ?>
            ...
            <form class="form-horizontal" id="form"  action="<?php echo url('admin/link/store'); ?>" method="post">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="link_name" value="<?php echo $oldData['link_name']; ?>">
                            </div>
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="link_url" value="<?php echo $oldData['link_url']; ?>">
                            </div>
