<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"/var/www/blog/public/../app/admin/view/category/index.tpl";i:1522590129;s:47:"/var/www/blog/public/../app/admin/view/base.tpl";i:1522660452;}*/ ?>
...
<div class="container-fluid admin_menu">
    <div class="row">
      ...
      <ol class="breadcrumb" style="background-color: #f9f9f9;padding:8px 0;margin-bottom:10px;">
                <li>
                    <a href="<?php echo url('admin/category/index'); ?>"><i class="fa fa-cogs"></i>
                        栏目管理</a>
                </li>
                <li class="active">
            ...
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li><a href="<?php echo url('admin/category/addtage'); ?>">添加栏目</a></li>
            </ul>
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <table class="table table-hover">
                            ...
                            <tbody>
                            <?php if(is_array($lanmu) || $lanmu instanceof \think\Collection || $lanmu instanceof \think\Paginator): if( count($lanmu)==0 ) : echo "" ;else: foreach($lanmu as $key=>$vo): ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            <ul class="dropdown-menu dropdown-menu-right">
                                                ...
                                                <li><a href="<?php echo url('admin/category/edit',['cate_id'=>$vo['cate_id']]); ?>">编辑</a></li>
                                                <li class="divider"></li>
                                                <li><a href="<?php echo url('admin/category/del',['cate_id'=>$vo['cate_id']]); ?>">删除</a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
